...
import { MAIN_SYSTEM_PROMPT, ADD_EVENT_SYSTEM_PROMPT, QUERY_FREE_TIME_SYSTEM_PROMPT } from './intent.js';
...
async function handleAddEvent(intent) {
...
async function handleQueryFreeTime(intent) {
...
async function processInput(input) {
    try {
        ...
        const initialIntent = await promptLLM(input, systemPrompt);
