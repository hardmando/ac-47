...
export function getBusySlots(icsPath: string, windowStart: DateTime, windowEnd: DateTime): BusySlot[] {
...
export function findFreeSlots(busySlots: BusySlot[], windowStart: DateTime, windowEnd: DateTime, durationMinutes: number): BusySlot[] {
